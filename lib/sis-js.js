...
(function() {
    ...
    if (typeof module !== 'undefined' && module.exports) {
        ...
        // use xmlhttpreq
        // callback expects 3 objects - err, res, and json obj
        request = function(opts, callback) {
            ...
            if ('withCredentials' in xhr) {
                ...
                xhr.onreadystatechange = function() {
                    if (xhr.readyState == 4) {
                        if (xhr.status >= 200 && xhr.status < 300) {
                            ...
                            callback(null, xhr, res);
                        } else {
                            callback(xhr.responseText || "The request could not be completed", xhr, null);
                        }
                    }
                };
                ...
                return callback("CORS not supported in this environment.", null);
            }
        }
