        ...
        wrapCallback = function(callback) {
            return function(err, response, body) {
                ...
                if (response.statusCode >= 200 && response.statusCode < 300){
                    ...
                    callback(err, body, response.statusCode);
                } else {
                    callback(body || wrapError("The request could not be completed"), null, response.statusCode);
                }
            };
        };
                    ...
                    if (xhr.readyState == 4) {
                        if (xhr.status >= 200 && xhr.status < 300) {
                            ...
                            if (xhr.responseText) {
                                ...
                                callback(wrapError("Error receiving response from server."), null, xhr.status);
                            }
                        }
                    }
                };
